# TaxoGrafo: Construção Automatizada de Grafos de Conhecimento Educacional
...
Este projeto é distribuído sob a licença copyleft AGPLv3. Isso garante que qualquer trabalho derivado ou serviço de rede baseado nele também permaneça de código aberto. Consulte o arquivo [`LICENSE.md`](./LICENSE.md) para os termos completos.
